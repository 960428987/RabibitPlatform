...
* 作    者 ：welus
* 创建时间 ：2019/11/9 10:32:36
* 更新时间 ：2019/11/9 10:32:36
* 版 本 号 ：v1.0.0.0
*******************************************************************
...
namespace RabbitPlatform.Core
{
    public class FileHelper
    {
        ...
        public static void CreateDir(string dir)
        {
            ...
            if (!Directory.Exists(MyServiceProvider.ServiceProvider.GetRequiredService<HostingEnvironment>().WebRootPath + "\\" + dir))
                Directory.CreateDirectory(MyServiceProvider.ServiceProvider.GetRequiredService<HostingEnvironment>().WebRootPath + "\\" + dir);
        }
        #endregion
        ...
        public static void DeleteDir(string dir)
        {
            if (dir.Length == 0) return;
            if (Directory.Exists(MyServiceProvider.ServiceProvider.GetRequiredService<HostingEnvironment>().WebRootPath + "\\" + dir))
                Directory.Delete(MyServiceProvider.ServiceProvider.GetRequiredService<HostingEnvironment>().WebRootPath + "\\" + dir);
        }
        #endregion
        ...
        {
            if (File.Exists(MyServiceProvider.ServiceProvider.GetRequiredService<HostingEnvironment>().WebRootPath + file))
            {
                File.Delete(MyServiceProvider.ServiceProvider.GetRequiredService<HostingEnvironment>().WebRootPath + file);
            }
        }
        #endregion
        ...
        public static void CreateFile(string dir, string pagestr)
        {
            ...
            StreamWriter sw = new StreamWriter(MyServiceProvider.ServiceProvider.GetRequiredService<HostingEnvironment>().WebRootPath + "\\" + dir, false, System.Text.Encoding.GetEncoding("GB2312"));
            sw.Write(pagestr);
            sw.Close();
        }
        /// <summary>
        ...
        public static void MoveFile(string dir1, string dir2)
        {
            dir1 = dir1.Replace("/", "\\");
            dir2 = dir2.Replace("/", "\\");
            if (File.Exists(MyServiceProvider.ServiceProvider.GetRequiredService<HostingEnvironment>().WebRootPath + "\\" + dir1))
                File.Move(MyServiceProvider.ServiceProvider.GetRequiredService<HostingEnvironment>().WebRootPath + "\\" + dir1, MyServiceProvider.ServiceProvider.GetRequiredService<HostingEnvironment>().WebRootPath + "\\" + dir2);
        }
        #endregion
        ...
        public static void CopyFile(string dir1, string dir2)
        {
            ...
            if (File.Exists(MyServiceProvider.ServiceProvider.GetRequiredService<HostingEnvironment>().WebRootPath + "\\" + dir1))
            {
                File.Copy(MyServiceProvider.ServiceProvider.GetRequiredService<HostingEnvironment>().WebRootPath + "\\" + dir1, MyServiceProvider.ServiceProvider.GetRequiredService<HostingEnvironment>().WebRootPath + "\\" + dir2, true);
            }
        }
        #endregion
        ...
        {
            directoryPath = MyServiceProvider.ServiceProvider.GetRequiredService<HostingEnvironment>().WebRootPath + "\\" + directoryPath;
            if (IsExistDirectory(directoryPath))
            {
                //删除目录中所有的文件
                string[] fileNames = GetFileNames(directoryPath);
        ...
        {
            return MyServiceProvider.ServiceProvider.GetRequiredService<HostingEnvironment>().WebRootPath + "\\" + path;
        }
        #endregion
    }
}
